...
//ストーリーラインを掘り進む
-(void)digStoryLine:(NSArray*)storyLines{
    for( MVStoryLine* story in storyLines ){
        NSLog(@"%@",story);
        for(MVSegment* segment in story.segments){
            
            NSLog(@"地点名:%@",segment.place.name);
